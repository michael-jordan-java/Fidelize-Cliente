...
public abstract class MaskFormattUtil {
    ...
    public static TextWatcher maskCPF(final EditText editText, final Context context) {
    ...
    public static TextWatcher maskCelualr(final EditText editText, final Context context) {
        return new TextWatcher() {
            boolean isUpdating;
            String old = "";
